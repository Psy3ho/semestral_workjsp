...
<!-- Main Content -->
<form enctype="multipart/form-data" class="text-center border border-light p-5" name="form" action="AddPostServlet" method="post" onsubmit="return validate()">

    <!-- userId -->
    <input type="hidden" name="user_id" id="user_id" value="<%=user.getId()%>"/>

    <!-- Name -->
    <input type="text" name="title" id="defaultContactFormName" class="form-control mb-4" placeholder="Názov článku">


    <!-- Message -->
    <div class="form-group">
        <textarea class="form-control rounded-0" name="text" id="exampleFormControlTextarea2" rows="10" placeholder="Text článku"></textarea>
    </div>

    <!-- Send picture -->
    <div class="panel panel-default">
        <div class="panel-heading">
            Pridať titulný obrázok
        </div>
    ...
    <!-- Send button -->
    <button class="btn btn-info btn-block" type="submit">Pridať príspevok</button>
